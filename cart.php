            ...
            <section aria-labelledby="cart-heading">
                ...
                <ul role="list" class="divide-y divide-gray-200 border-b border-t border-gray-200">
                    <?php foreach ($cart_items as $item): ?>
                        <li class="flex py-6">
                            <div class="shrink-0">
                                <img src="http://localhost/SupplyEaseUpdate/admin/pages/<?php echo htmlspecialchars($item['product_image']); ?>" alt="<?php echo htmlspecialchars($item['product_name']); ?>" class="size-24 rounded-md object-cover sm:size-32">
                            </div>

        ...
        <div class="mt-8 lg:col-span-7 lg:col-start-1 lg:row-span-3 lg:row-start-1 lg:mt-0">
          ...
          <div class="relative">
            ...
            <div class="carousel-container relative">
              <!-- Main product image -->
              <img src="http://localhost/SupplyEaseUpdate/admin/pages/<?php echo htmlspecialchars($product['image1']); ?>" 
              ...
              <img src="http://localhost/SupplyEaseUpdate/admin/pages/<?php echo htmlspecialchars($product['image2']); ?>" 
              ...
              <img src="http://localhost/SupplyEaseUpdate/admin/pages/<?php echo htmlspecialchars($product['image3']); ?>" 

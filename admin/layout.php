...
<div>
  ...
  <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
    ...
    <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6">
      <div class="flex h-16 shrink-0 items-center">
        <h1 class="text-green-600 font-semibold text-xl">
          SupplyEase -  Admin
        </h1>
        <!-- <img class="h-8 w-auto" src="https://tailwindui.com/plus/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company"> -->
      </div>
      <nav class="flex flex-1 flex-col">
        <ul role="list" class="flex flex-1 flex-col gap-y-7">
          <li>
            ...
            <li>
                <a href="index.php?page=dashboard" 
                    ...
                    <?= isset($_GET['page']) && $_GET['page'] === 'dashboard' ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800'; ?>">
              ...
              <li>
                <a href="index.php?page=categories" 
                    class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold 
                    <?= isset($_GET['page']) && ($_GET['page'] === 'categories' || $_GET['page'] === 'create-category' || $_GET['page'] === 'edit-category') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800'; ?>">
                      <svg class="size-6 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
              ...
              <li>
                <a href="index.php?page=products" 
                    class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold 
                    <?= isset($_GET['page']) && ($_GET['page'] === 'products' || $_GET['page'] === 'create-product' || $_GET['page'] === 'edit-product') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800'; ?>">
                      <svg class="size-6 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
              ...
              <li>
                ...
                class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold 
                <?= isset($_GET['page']) && ($_GET['page'] === 'orders' || $_GET['page'] === 'view-order') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800'; ?>">
                  <svg class="size-6 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
              ...
              <!-- <li>
                <a href="index.php?page=users" class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-gray-400 hover:bg-gray-800 hover:text-white">
                  <svg class="size-6 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
                  </svg>
                  Users
          ...
          <li class="-mx-6 mt-auto">
            <button onclick="confirmLogout()" type="button" class="flex items-center gap-x-4 px-6 py-3 text-sm/6 font-semibold text-white hover:bg-gray-800">
  ...
  <main class="py-10 lg:pl-72">
    ...
    <?php 
                // Include the dynamically determined content page
                if (isset($full_path)) {
                    include($full_path); 
                } else {
...
<script>
    // Function to show confirmation before logging out
